...
ATLAS_IMAGE_PATH = '/home/uray/latest_OAI/OAI_analysis/atlas/atlas_60_LEFT_baseline_NMI/atlas.nii.gz'
...
ATLAS_FC_MESH_PATH = os.path.join(os.getcwd(),"/home/uray/latest_OAI/OAI_analysis/data/atlas_FC_inner_mesh_world.ply")
ATLAS_TC_MESH_PATH = os.path.join(os.getcwd(),"/home/uray/latest_OAI/OAI_analysis/data/atlas_TC_inner_mesh_world.ply")
ATLAS_FC_2D_MAP_PATH = os.path.join(os.getcwd(), "/home/uray/latest_OAI/OAI_analysis/data/FC_inner_embedded.npy")
ATLAS_TC_2D_MAP_PATH = os.path.join(os.getcwd(), "/home/uray/latest_OAI/OAI_analysis/data/TC_inner_embedded.npy")
...
def demo_analyze_cohort(use_nifti,avsm_path=None, do_clean=False):
    comm=MPI.COMM_WORLD
    OAI_data_sheet ="/tmp/uray/SEG_3D_DESS_6visits.csv"
    ...
    patients_ASCII_file_path = "/home/uray/latest_OAI/OAI_analysis/data/Enrollees.txt"
    ...
    progression_cohort_images = OAI_data.get_images(visit_month=[36])
