...
from misc.image_transforms import Partition
from segmentation.train import train_segmentation
from segmentation.utils import initialize_model
from misc.module_parameters import load_jason_to_dict
from segmentation.networks import get_network
class Segmenter(ABC):
    @abstractmethod
