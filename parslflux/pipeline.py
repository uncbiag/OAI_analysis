...
class PipelineManager:
    ...
    def scale_down_configuration (self, rmanager, pipelinestageindex, underutilization, throughput, available_resources):
        to_be_deleted = []
        target_throughput = (1 - underutilization) * throughput
