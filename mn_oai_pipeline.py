...
ATLAS_IMAGE_PATH = '/playpen/oai/OAI_analysis/atlas/atlas_60_LEFT_baseline_NMI/atlas_image.nii.gz'
...
NIFTY_REG_PATH = "/playpen/oai/niftyreg/install/bin"
OAI_DATA_PATH = '/net/biag-raid/playpen/data/OAI' # /playpen/zhenlinx/data/OAI' # '/playpen-raid/data/OAI'
...
def demo_analyze_single_image(use_nifti,avsm_path=None,do_clean=False):
    ...
    OAI_data.set_processed_data_paths(OAI_ANALYSIS_RESULTS_OUTPUT_PATH,None if use_nifti else 'avsm')
